#import "CMReceiptsApi.h"
#import "CMQueryParamCollection.h"
#import "CMApiClient.h"


@interface CMReceiptsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CMReceiptsApi

NSString* kCMReceiptsApiErrorDomain = @"CMReceiptsApiErrorDomain";
NSInteger kCMReceiptsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) receiptsPhotoToCSVWithImageFile: (NSURL*) imageFile
    ...
    if (imageFile == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMReceiptsApiErrorDomain code:kCMReceiptsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ocr/receipts/photo/to/csv"];
