...
-(NSURLSessionTask*) preprocessingBinarizeWithImageFile: (NSURL*) imageFile
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ocr/preprocessing/image/binarize"];
...
-(NSURLSessionTask*) preprocessingBinarizeAdvancedWithImageFile: (NSURL*) imageFile
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ocr/preprocessing/image/binarize/advanced"];
...
-(NSURLSessionTask*) preprocessingGetPageAngleWithImageFile: (NSURL*) imageFile
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ocr/preprocessing/image/get-page-angle"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMGetPageAngleResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMGetPageAngleResult*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) preprocessingUnrotateAdvancedWithImageFile: (NSURL*) imageFile
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ocr/preprocessing/image/unrotate/advanced"];
